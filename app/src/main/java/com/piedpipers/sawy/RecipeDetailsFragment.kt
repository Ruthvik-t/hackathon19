 ...
 */
class RecipeDetailsFragment : DetailsFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mSelectedMovie = activity.intent.getSerializableExtra(RecipeDetailsActivity.MOVIE) as Movie
    ...
    private fun setupDetailsOverviewRowPresenter() {
        ...
        sharedElementHelper.setSharedElementEnterTransition(
            activity, RecipeDetailsActivity.SHARED_ELEMENT_NAME
        )
        ...
        detailsPresenter.onActionClickedListener = OnActionClickedListener { action ->
            if (action.id == ACTION_WATCH_TRAILER) {
                ...
                intent.putExtra(RecipeDetailsActivity.MOVIE, mSelectedMovie)
                startActivity(intent)
            } else {
            ...
            if (item is Movie) {
                ...
                val bundle =
                    ActivityOptionsCompat.makeSceneTransitionAnimation(
                        ...
                        RecipeDetailsActivity.SHARED_ELEMENT_NAME
                    )
                        .toBundle()
